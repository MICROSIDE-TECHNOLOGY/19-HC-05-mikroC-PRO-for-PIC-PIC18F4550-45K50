...
;SERIAL.c,25 :: 		void main() org 0x2000               //Se define el registro a partir del cual se alamcenara el codigo lógico
...
;SERIAL.c,34 :: 		while(1){
L_main0:
;SERIAL.c,35 :: 		if (UART1_Data_Ready() == 1) {   //Pregunta si ha recibido algún dato por el puerto serial
...
;SERIAL.c,47 :: 		else if (Caracter == '?') {
	...
	BTFSS       STATUS+0, 2 
	GOTO        L_main7
;SERIAL.c,48 :: 		if (BOTON==1) {              //Pregunta el estado del botón
	BTFSS       PORTA+0, 2 
	GOTO        L_main8
;SERIAL.c,49 :: 		UART1_Write('0');          //Envía un 0 si el botón no está presionado
	MOVLW       48
...
;SERIAL.c,50 :: 		} else {
	GOTO        L_main9
L_main8:
;SERIAL.c,51 :: 		UART1_Write('1');          //Envía un 1 si el botón está presionado
	MOVLW       49
	MOVWF       FARG_UART1_Write_data_+0 
	CALL        _UART1_Write+0, 0
;SERIAL.c,52 :: 		}
